...
class DynamicQueueDQNAgent(BaseAgent):
    """
    DQN Agent for Dynamic Queue Environment.
    - State size: 87 dimensions
    - Action size: 21 (21 activities, no mock action)
    - Uses standard DQN learning with action masking
    """
    
    def __init__(self, state_size=87, action_size=21, seed=0, **kwargs):
